...
Object.defineProperty(exports, "__esModule", { value: true });
const needle = __webpack_require__(2);
const vscode = __webpack_require__(54);
const utilities_1 = __webpack_require__(55);
const uuidv4 = __webpack_require__(56);
class ApiClient {
    /**
     * @constructor
     * @param subKeyTranslator
     */
    constructor(subKeyTranslator) {
        this.TRANSLATE_API_ENDPOINT = "https://api.cognitive.microsofttranslator.com/translate";
     ...
     * @param targetlang
     */
    translate(text, targetlang = 'ja') {
        this.translateInternal(text, targetlang)
            .then((jsontext) => {
            let item = jsontext[0];
            let translated_text = item["translations"][0]["text"];
     ...
     * @param targetlang
     */
    translateInternal(text, targetlang = 'ja') {
        let options = {
            headers: {
        ...
        let qs = utilities_1.Utilities.queryString({
            'api-version': '3.0',
            'to': [targetlang]
        });
        return new Promise((resolve, reject) => {
            needle.post(`${this.TRANSLATE_API_ENDPOINT}?${qs}`, body, options, function (err, res) {
                if (err) {
                    return reject(err);
                }
...
var fs          = __webpack_require__(3),
    ...
    stringify   = __webpack_require__(18).build,
    multipart   = __webpack_require__(19),
    auth        = __webpack_require__(21),
    cookies     = __webpack_require__(23),
    parsers     = __webpack_require__(25),
...
var readFile = __webpack_require__(3).readFile,
    basename = __webpack_require__(20).basename;
...
var createHash = __webpack_require__(22).createHash;
...
var unescape = __webpack_require__(24).unescape;
...
var sax = __webpack_require__(26);
...
module.exports = function(charset) {
  try {
    if (!iconv) iconv = __webpack_require__(29);
  } catch(e) {
    /* iconv not found */
  }
...
class Utilities {
     ...
     * @param langcode
     */
    static isSupportedlanguageCode(langcode) {
        let c = langcode.toLowerCase();
        return (!Utilities.isEmptyString(c)
            && (c in LANGUAGE_MAP));
    }
}
...
var rng = __webpack_require__(57);
...
Object.defineProperty(exports, "__esModule", { value: true });
const vscode = __webpack_require__(54);
const apiclient_1 = __webpack_require__(1);
const utilities_1 = __webpack_require__(55);
let targetLanguageCode, isVerified, apiclient;
function loadConfig() {
    let { subKeyTranslator, targetLanguage, } = vscode.workspace.getConfiguration("mytranslator");
    targetLanguageCode = targetLanguage;
    apiclient = new apiclient_1.ApiClient(subKeyTranslator);
    if (!utilities_1.Utilities.isSupportedlanguageCode(targetLanguageCode)) {
...
function activate(context) {
    ...
    loadConfig();
    // Register command
    let disposable_translate = vscode.commands.registerCommand('extension.mytranslator.translate', () => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (editor) {
                ...
                const text = editor.document.getText(new vscode.Range(editor.selections[0].start, editor.selections[0].end));
    ...
    context.subscriptions.push(disposable_translate, disposable_configchange);
}
